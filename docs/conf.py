...
latex_documents = [
  ('index', 'TRAPI.tex', u'TR API Documentation',
...
man_pages = [
    ('index', 'TR', u'TR API Documentation',
...
texinfo_documents = [
  ('index', 'TR API', u'TR API Documentation',
   u'Continuum Analytics', 'TR API', 'One line description of project.',
   'Miscellaneous'),
]
